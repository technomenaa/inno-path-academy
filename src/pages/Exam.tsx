...
const examQuestions = {
  "concrete-1": [
    ...
    {
      id: 6,
      question: "ما هي المدة الزمنية المطلوبة لتصلب الخرسانة أولياً؟",
      options: ["30 دقيقة", "2-4 ساعات", "24 ساعة", "7 أيام"],
      correctAnswer: 1
    },
    {
      id: 7,
      question: "ما هو الحد الأدنى للغطاء الخرساني لحديد التسليح في البيئة العادية؟",
      options: ["15 مم", "25 مم", "35 مم", "50 مم"],
      correctAnswer: 1
    },
    {
      id: 8,
      question: "ما هي طريقة التصميم المعتمدة في المعايير الحديثة؟",
      options: ["طريقة الإجهادات المسموحة", "طريقة حالات الحد", "طريقة المرونة", "طريقة اللدونة"],
      correctAnswer: 1
    },
    {
      id: 9,
      question: "ما هو الحد الأقصى لنسبة حديد التسليح في المقطع؟",
      options: ["1%", "2%", "4%", "6%"],
      correctAnswer: 2
    },
    {
      id: 10,
      question: "ما هي أنواع الأحمال التي تؤثر على المنشآت الخرسانية؟",
      options: ["أحمال ميتة فقط", "أحمال حية فقط", "أحمال ميتة وحية", "أحمال ميتة وحية وبيئية"],
      correctAnswer: 3
    }
  ],
  "structural-1": [
    ...
    {
      id: 6,
      question: "ما هو شرط التوازن الأساسي للقوى؟",
      options: ["مجموع القوى = 1", "مجموع القوى = صفر", "مجموع القوى > صفر", "مجموع القوى < صفر"],
      correctAnswer: 1
    },
    {
      id: 7,
      question: "في التحليل الإنشائي، ما هي درجة عدم التعيين للكمرة المثبتة من طرفين؟",
      options: ["صفر", "واحد", "اثنان", "ثلاثة"],
      correctAnswer: 2
    },
    {
      id: 8,
      question: "ما هي طريقة التحليل المناسبة للمنشآت الساكنة التعيين؟",
      options: ["طريقة القوى", "طريقة التشوهات", "طريقة التوازن", "جميع ما سبق"],
      correctAnswer: 2
    },
    {
      id: 9,
      question: "في الكمرة المحملة بحمولة موزعة منتظمة، كيف يتغير العزم؟",
      options: ["خطياً", "تربيعياً", "تكعيبياً", "أسياً"],
      correctAnswer: 1
    },
    {
      id: 10,
      question: "ما هو مبدأ المقابلة في التحليل الإنشائي؟",
      options: ["تساوي التشوهات", "تساوي القوى", "تساوي العزوم", "تساوي ردود الأفعال"],
      correctAnswer: 0
    }
  ],
  "materials-1": [
    ...
    {
      id: 6,
      question: "ما هي العوامل التي تؤثر على قوة الخرسانة؟",
      options: ["نسبة الماء فقط", "نوع الأسمنت فقط", "نسبة الماء ونوع الأسمنت", "جميع المكونات والظروف البيئية"],
      correctAnswer: 3
    },
    {
      id: 7,
      question: "ما هو الحد الأقصى لحجم الركام الخشن المستخدم في الخرسانة؟",
      options: ["10 مم", "20 مم", "40 مم", "50 مم"],
      correctAnswer: 2
    },
    {
      id: 8,
      question: "ما هي طريقة اختبار مقاومة الشد للخرسانة؟",
      options: ["اختبار الضغط المباشر", "اختبار الانقسام البرازيلي", "اختبار الانحناء", "ب وج صحيحان"],
      correctAnswer: 3
    },
    {
      id: 9,
      question: "ما هو الهدف من إضافة المواد المضافة للخرسانة؟",
      options: ["تحسين قابلية التشغيل", "تسريع أو تأخير التصلب", "تحسين المقاومة", "جميع ما سبق"],
      correctAnswer: 3
    },
    {
      id: 10,
      question: "ما هو معامل المرونة التقريبي للخرسانة ذات مقاومة 25 ميجا باسكال؟",
      options: ["20,000 ميجا باسكال", "25,000 ميجا باسكال", "30,000 ميجا باسكال", "35,000 ميجا باسكال"],
      correctAnswer: 1
    }
  ]
};
...
const Exam = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(45 * 60); // 45 minutes for 10 questions
